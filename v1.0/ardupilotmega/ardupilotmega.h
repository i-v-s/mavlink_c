...
#include "./mavlink_msg_ros_info.h"
#include "./mavlink_msg_ros_node_state.h"
#include "./mavlink_msg_rpg_svo_info.h"
#include "./mavlink_msg_rpg_svo_key.h"
#include "./mavlink_msg_ros_cmd_launch.h"
