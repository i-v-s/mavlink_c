...
static void mavlink_test_ros_info(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_ros_info_t packet_in = {
		17235,139,"DEFGHIJKLMNOPQRSTUVWXYZ",22
    };
	mavlink_ros_info_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	packet1.host_id = packet_in.host_id;
        	packet1.state = packet_in.state;
        	packet1.node_count = packet_in.node_count;
        
        	mav_array_memcpy(packet1.host, packet_in.host, sizeof(char)*24);
	...
	mavlink_msg_ros_info_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_ros_info_pack(system_id, component_id, &msg , packet1.host_id , packet1.state , packet1.host , packet1.node_count );
	mavlink_msg_ros_info_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_ros_info_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.host_id , packet1.state , packet1.host , packet1.node_count );
	mavlink_msg_ros_info_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_ros_info_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_ros_info_send(MAVLINK_COMM_1 , packet1.host_id , packet1.state , packet1.host , packet1.node_count );
	mavlink_msg_ros_info_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_ros_cmd_launch(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_ros_cmd_launch_t packet_in = {
		"ABCDEFGHIJKLMNOPQRSTUVWXYZABCDE"
    };
	mavlink_ros_cmd_launch_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        
        	mav_array_memcpy(packet1.launch_file, packet_in.launch_file, sizeof(char)*32);
        

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_ros_cmd_launch_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_ros_cmd_launch_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_ros_cmd_launch_pack(system_id, component_id, &msg , packet1.launch_file );
	mavlink_msg_ros_cmd_launch_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_ros_cmd_launch_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.launch_file );
	mavlink_msg_ros_cmd_launch_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_ros_cmd_launch_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_ros_cmd_launch_send(MAVLINK_COMM_1 , packet1.launch_file );
	mavlink_msg_ros_cmd_launch_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_ardupilotmega(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_test_ros_cmd_launch(system_id, component_id, last_msg);
}
